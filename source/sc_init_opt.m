...
% Patch size
% =========================================================================
optS.pSize = 21;                       % Patch size (odd number), use larger patch for more coherent region
...
% =========================================================================
optS.numPyrLvl = 9;                   % Number of coarse to fine layer
...
% Planar cost
optS.lambdaPlane  = 5e-3;               % Weighting parameters for planar cost

% Directional cost
%optS.lambdaDirect = 5;                  % Weighting parameters for directional cost
%optS.directThres  = 0.5;               % Directional cost threshold
optS.lambdaDirect = 0.5;                  % Weighting parameters for directional cost
optS.directThres  = 0.5;               % Directional cost threshold

%optS.lambdaProx   = 0.5e-2;               % Weighting parameters for proximity cost original
optS.lambdaProx   = 0.5e-3;               % Weighting parameters for proximity cost
optS.proxThres    = 0.25;
